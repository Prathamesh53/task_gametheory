...
const Card = ({ data }: { data: any }) => { 
    ...
    return (
        <div onClick={() => handleClick()} className={`cursor-pointer flex-shrink-0 inline-block m-6 h-92 relative transition-all hover:scale-105 overflow-hidden ${data.bg} rounded-lg max-w-xs shadow-lg`}>
